...
//error detection for missing markers. cancels script if missing
{
	if (getMarkerColor _x == "") exitWith { //should be colorCiv. if missing, will be ""
		...
		diag_log text "PROF-Mission-Template WARNING: You have enabled the Rallypoint system in the mission template options, but the mission.sqm does not contain the needed rallypoint markers! Disabling Rallypoints system...";
	};
...
player createDiaryRecord ["PROFMissionTemplate", ["Rallypoints", "Enabled.<br><br>See briefing section for tutorial on the Rallypoint system."]];
...
if (
	...
	private _Rally_CMD_Action = ["rallyCMD","Place Squad Rallypoint","",{[3,[],{[] call PROF_fnc_cmdRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
...
/*if (_playerClass == "ALPHA_Actual") then {
	_Rally_Alpha_Action = ["rallyAlpha","Place Squad Rallypoint","",{[] call PROF_fnc_alphaRallypoint;},{true}] call ace_interact_menu_fnc_createAction;
...
if (_playerClass == "ALPHA_Actual" || ("Squad Leader" in _playerRoleDescription && "Alpha" in _playerRoleDescription)) then { //doesn't handle nearly enough edge cases in role description names
	private _Rally_Alpha_Action = ["rallyAlpha","Place Squad Rallypoint","",{[3,[],{[] call PROF_fnc_alphaRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
	[player, 1, ["ACE_SelfActions"], _Rally_Alpha_Action] call ace_interact_menu_fnc_addActionToObject;
};

if (_playerClass == "BRAVO_Actual" || ("Squad Leader" in _playerRoleDescription && "Bravo" in _playerRoleDescription)) then {
	private _Rally_Bravo_Action = ["rallyBravo","Place Squad Rallypoint","",{[3,[],{[] call PROF_fnc_bravoRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
...
if (_playerClass == "CHARLIE_Actual" || ("Squad Leader" in _playerRoleDescription && "Charlie" in _playerRoleDescription)) then {
	private _Rally_Charlie_Action = ["rallyCharlie","Place Squad Rallypoint","",{[3,[],{[] call PROF_fnc_charlieRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
...
if (_playerClass == "DELTA_Actual" || ("Squad Leader" in _playerRoleDescription && "Delta" in _playerRoleDescription)) then {
	private _Rally_Delta_Action = ["rallyDelta","Place Squad Rallypoint","",{[3,[],{[] call PROF_fnc_deltaRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
...
if (_playerClass == "ECHO_Actual" || ("Squad Leader" in _playerRoleDescription && "Echo" in _playerRoleDescription)) then {
	private _Rally_Echo_Action = ["rallyEcho","Place Squad Rallypoint","",{[3,[],{[] call PROF_fnc_echoRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
...
if (_playerClass == "FOXTROT_Actual" || ("Squad Leader" in _playerRoleDescription && "Foxtrot" in _playerRoleDescription)) then {
	private _Rally_Foxtrot_Action = ["rallyFoxtrot","Place Squad Rallypoint","",{[3,[],{[] call PROF_fnc_foxtrotRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
...
if (_playerClass == "GOLF_Actual" || ("Squad Leader" in _playerRoleDescription && "Golf" in _playerRoleDescription)) then {
	private _Rally_Golf_Action = ["rallyGolf","Place Squad Rallypoint","",{[3,[],{[] call PROF_fnc_golfRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
...
if (_playerClass == "HOTEL_Actual" || ("Squad Leader" in _playerRoleDescription && "Hotel" in _playerRoleDescription)) then {
	private _Rally_Hotel_Action = ["rallyHotel","Place Squad Rallypoint","",{[3,[],{[] call PROF_fnc_hotelRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
...
if (_playerClass == "Recon_Actual" || ("Leader" in _playerRoleDescription && "Recon" in _playerRoleDescription)) then { //assumes that recon is a smaller team without two leaders
	private _Rally_Recon_Action = ["rallyRecon","Place Squad Rallypoint","",{[3,[],{[] call PROF_fnc_reconRallypoint;},{},"Establishing rallypoint..."] call ace_common_fnc_progressBar},{true}] call ace_interact_menu_fnc_createAction;
