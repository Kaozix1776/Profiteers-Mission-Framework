...
[_unit,10] call PROF_fnc_aceJuggernaut;
[_unit,10] remoteExec ["PROF_fnc_aceJuggernaut",_unit];
*/
...
_unit setVariable ["PROF_fnc_juggernautHitsBeforeDeath",_hitsBeforeDeath]; 
...
_unit addEventHandler ["HitPart", {
	...
	if (_hits > (_target getVariable ["PROF_fnc_juggernautHitsBeforeDeath",10]) ) then { _target setdamage 1} else {
